export function SportsHighlights({ items }: { items: Array<{ title: string; category: string; summary: string }> }) {
  return (
    <section className="bg-slate py-20">
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        <div className="mb-10">
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-blue">Sports highlights</p>
          <h2 className="mt-2 text-3xl font-bold text-navy md:text-4xl">School pride in motion</h2>
        </div>
